...
void puzle_despacho(partida *p){
    ...
    printf("Es raro que arriba del panel de acceso hay como unos circulos de colores, el primero es rojo, el segundo azul, el tercero verde y el ultimo amarillo\n");
}
